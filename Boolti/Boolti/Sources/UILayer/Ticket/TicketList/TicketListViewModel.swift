...
final class TicketListViewModel {
    ...
    private func fetchTicketItemsByAPI() -> Single<[TicketItem]> {
        ...
        let items: [TicketItem] = [
            ...
            TicketItem(ticketType: "일반 티켓 B", poster: .mockPosterTwo, title: "2024 TOGETHER LUCKY CLUB SEFVDVDSFESVEFSFEFSEVESFEFESF", date: "2024.01.20 (토)", location: "클럽샤프", qrCode: .qrCode, number: 2),
